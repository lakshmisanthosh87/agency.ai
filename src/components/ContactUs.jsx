...
const ContactUs = () => {
  return (
    <div id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        ...
        <form className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-x-2xl w-full'>

            <div>
                <p className='mb-2 text-sm font-medium'>Your name</p>
                <div className='flex pl-3 rounded-b-lg border border-gray-300 dark:border-gray-600'>
            ...
            <button type="submit" className='w-max flex gap-2 bg-primary text-white text-sm px-10 py-3 rounded-full cursor-pointer hover:scale-103 transition-all'>submit <img src={assets.arrow_icon} className='w-4'/></button>
